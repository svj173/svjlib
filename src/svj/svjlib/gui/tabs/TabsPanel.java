 ...
 */
public class TabsPanel<T extends WPanel> extends WPanel implements WComponent
//public class TabsPanel<T extends JPanel> extends WPanel  implements WComponent
{
     ...
     *
     */
    public void removeTab ( T tabPanel ) throws WEditException
    {
        String removeKey;
        T       panel;
        int     ic;

        if ( tabPanel == null )  throw new WEditException ( "Нельзя удалить NULL таб." );
        ...
        else
        {
            ...
            throw new WEditException ( "Не удалось удалить таб '" + tabPanel.getName() + "'." );
        }
    ...
    */
    ...
    /*
    public JLabel addPanel (T paramsPanel, String tabId, String tabName, Icon icon)
    {
        ...
        else
        {
            ...
            tabTitleLabel   = GuiTools.addClosableTab ( tabbedPane, paramsPanel, tabName, icon );
        }
